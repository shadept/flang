...
pub fn clone_operand_list(args: &List(Operand), subst: &Dict(u32, Operand),
...
pub fn rewrite_terminator(t: &Terminator, subst: &Dict(u32, Operand),
    alloc: &Allocator?) Terminator {
    return t.* match {
