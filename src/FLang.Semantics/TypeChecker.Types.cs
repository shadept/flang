...
public partial class TypeChecker
{
    ...
    private static ExpressionNode CloneExpression(ExpressionNode expr) => expr switch
    {
        ...
        CallExpressionNode call => new CallExpressionNode(call.Span, call.FunctionName, [.. call.Arguments.Select(CloneExpression)], call.UfcsReceiver != null ? CloneExpression(call.UfcsReceiver) : null, call.MethodName),
        ...
        RangeExpressionNode range => new RangeExpressionNode(range.Span, range.Start != null ? CloneExpression(range.Start) : null, range.End != null ? CloneExpression(range.End) : null),
        ...
        MatchExpressionNode match => new MatchExpressionNode(match.Span, CloneExpression(match.Scrutinee), [.. match.Arms.Select(a => new MatchArmNode(a.Span, a.Pattern, CloneExpression(a.ResultExpr)))]),
        ArrayLiteralExpressionNode arr => new ArrayLiteralExpressionNode(arr.Span, [.. arr.Elements!.Select(CloneExpression)]),
