...
pub fn move_to(self: Writer, row: u32, col: u32) {
    write_csi(self)
    write_uint(self, row)
    self.write_byte(';')
    write_uint(self, col)
...
pub fn move_up(self: Writer, n: u32) {
    write_csi(self)
    write_uint(self, n)
    self.write_byte('A')
}
...
pub fn move_down(self: Writer, n: u32) {
    write_csi(self)
    write_uint(self, n)
    self.write_byte('B')
}
...
pub fn move_right(self: Writer, n: u32) {
    write_csi(self)
    write_uint(self, n)
    self.write_byte('C')
}
...
pub fn move_left(self: Writer, n: u32) {
    write_csi(self)
    write_uint(self, n)
    self.write_byte('D')
}
...
pub fn save_cursor(self: Writer) {
    write_csi(self)
    self.write_byte('s')
}

// Restore cursor position.  ESC [ u
pub fn restore_cursor(self: Writer) {
    write_csi(self)
    self.write_byte('u')
}

// Hide cursor.  ESC [ ? 25 l
pub fn hide_cursor(self: Writer) {
    write_csi(self)
    self.write_str("?25l")
}

// Show cursor.  ESC [ ? 25 h
pub fn show_cursor(self: Writer) {
    write_csi(self)
    self.write_str("?25h")
}
...
fn write_color_code(self: Writer, color: Color) {
    ...
    write_uint(self, code)
}

// Set foreground color.  ESC [ 3{c} m
pub fn set_fg(self: Writer, color: Color) {
    write_csi(self)
    self.write_byte('3')
    write_color_code(self, color)
    self.write_byte('m')
}

// Set background color.  ESC [ 4{c} m
pub fn set_bg(self: Writer, color: Color) {
    write_csi(self)
    self.write_byte('4')
    write_color_code(self, color)
    self.write_byte('m')
...
pub fn set_bright_fg(self: Writer, color: Color) {
    write_csi(self)
    self.write_byte('9')
    write_color_code(self, color)
    self.write_byte('m')
...
pub fn set_bright_bg(self: Writer, color: Color) {
    write_csi(self)
    write_uint(self, 10u32)
    write_color_code(self, color)
    self.write_byte('m')
}
...
pub fn set_style(self: Writer, style: Style) {
